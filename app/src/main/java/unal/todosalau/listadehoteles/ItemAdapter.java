...
public class ItemAdapter extends RecyclerView.Adapter<ItemAdapter.ViewHolder>{//crear metodo
    ...
    public ItemAdapter(List<Item> data, Context context) {
        this.data = data;
        this.inflater= LayoutInflater.from(context);//va inflar sobre el context
